...
Purpose: Installed diagnostic CLI that walks Wiren Board MQTT `/devices/#` like the plugin, prints human or JSON inventory, and annotates Matter exposure using the same helpers as the platform (no duplicated business rules).
